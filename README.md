...
- Figuring out how to add images into the resource folder for the different sizes and types
- Learning how to use TextInputLayout to show the word count for a new tweet
- Determining how to show an icon in the action bar
